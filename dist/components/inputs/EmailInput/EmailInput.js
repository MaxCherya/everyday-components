...
const EmailInput = ({ value, onChange, placeholder, name, id, variant = 'default', size = 'base', fullWidth = false, disabled = false, readonly = false, autoFocus = false, onFocus, onUnfocus, customPrimaryColor, customSecondaryColor, label, labelPosition = 'top', required = false, hint, hintPosition = 'bottom', error, setError, errorColor = '#ff3333', errorPosition = 'top', debounceMs, iconLeft, iconRight, onLeftIconClick, onRightIconClick, autoComplete = 'off', additionalEmailCheck = true, additionalEmailCheck_formatMessage, additionalEmailCheck_mxMessage, additionalEmailCheck_disposableMessage, additionalEmailCheck_errorMessage, allowedDomains, allowedDomainsMessage, className, classNameHint, classNameLabel, inputClassName, iconLeftClassName, iconRightClassName, customRequiredMessage, customValidEmailMessage }) => {
    // =========================== STATES ============================ //
    ...
    return (_jsxs("div", { className: `${fullWidth && 'w-full'} ${className}`, children: [hint &&
                ...
                _jsx("p", { style: {
                        ...
                        }, children: iconLeft }), _jsx("input", { type: "email", disabled: disabled, onChange: (e) => {
